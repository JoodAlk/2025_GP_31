...
import 'package:basser/DriverApp/app_frame.dart';
...
class _BinDashboardScreenState extends State<BinDashboardScreen> {
  // ✅ Start from whatever the driver last selected
  String _selectedAreaFilter = UserSession.selectedAreaFilter;

  // --- PRIORITY SORTER HELPER ---
  int _prioritySorter(Bin a, Bin b) {
    final aIsAssigned = a.isAssigned;
    final bIsAssigned = b.isAssigned;
  ...
  Widget build(BuildContext context) {
    final DatabaseReference binsRef = FirebaseDatabase.instance.ref('Baseer/bins');
    ...
    return AppFrame(
      ...
      child: StreamBuilder<DatabaseEvent>(
        ...
        builder: (context, snapshot) {
          ...
          final List<String> dynamicAreaOptions = ['All', ...uniqueAreas.toList()..sort()];

          if (!dynamicAreaOptions.contains(_selectedAreaFilter)) {
            _selectedAreaFilter = 'All';
            UserSession.selectedAreaFilter = 'All';
          }
                    ...
                    _buildDropdown(
                      ...
                      (newValue) {
                        ...
                        setState(() {
                          ...
                          UserSession.selectedAreaFilter = newValue;
                        });
                      },
                    ),
                  ],
...
class BinListItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final bool isAssigned = bin.isAssigned;
    final Color assignColor = isAssigned ? Colors.green : Colors.red;
    final String assignText = isAssigned ? "Assigned" : "Not Assigned";
