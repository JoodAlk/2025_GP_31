...
import 'driver_home_page.dart'; // Ensure this import is here for navigation
import 'user_session.dart'; // Ensure this import is here for session
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: RichText(
                        text: const TextSpan(
                          style: TextStyle(fontSize: 13, color: Colors.black87), // Default style
                          children: [
